...
class PlayIntroState extends FlxState
{
	...
	override public function create():Void
	{
		...
		nametag.loadGraphic('assets/images/intro/name.png');
		add(nametag);

		text0 = new FlxSprite(0, 30);
		text0.loadGraphic('assets/images/intro/text0.png');
		add(text0);
	...
	{
		FlxG.switchState(new PlayIntroState2());
	}
}