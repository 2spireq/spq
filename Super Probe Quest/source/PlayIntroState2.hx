...
class PlayIntroState2 extends FlxState
{
	...
	override public function create():Void
	{
		...
		nametag.loadGraphic('assets/images/intro/vab.png');
		add(nametag);

		text0 = new FlxSprite(0, 10);
		text0.loadGraphic('assets/images/intro/text1.png');
		add(text0);
	...
	{
		FlxG.switchState(new PlayIntroState3());
	}
}