...
class PlayIntroState4 extends FlxState
{
	...
	override public function create():Void
	{
		...
		nametag.loadGraphic('assets/images/intro/tower.png');
		add(nametag);

		text0 = new FlxSprite(0, 15);
		text0.loadGraphic('assets/images/intro/text3.png');
		add(text0);
	...
	{
		FlxG.switchState(new PlayIntroState5());
	}
}