...
class SwapCraftState4 extends FlxState
{
	...
	override public function create():Void
	{
		...
		timer = new FlxTimer().start(5, timeEnd, 1);
		...
		forward_0.loadGraphic('assets/images/swapcraft/parts/4forward_0.png', false, 64, 64);
		add(forward_0);

		forward_1 = new FlxButton(trayX + 64, trayY, '', f1);
		forward_1.loadGraphic('assets/images/swapcraft/parts/4forward_1.png', false, 64, 64);
		add(forward_1);

		forward_2 = new FlxButton(trayX + 128, trayY, '', f2);
		forward_2.loadGraphic('assets/images/swapcraft/parts/4forward_2.png', false, 64, 64);
		add(forward_2);

		forward_3 = new FlxButton(trayX + 192, trayY, '', f3);
		forward_3.loadGraphic('assets/images/swapcraft/parts/4forward_3.png', false, 64, 64);
		add(forward_3);
	...
	private function preview0():Void
	{
		...
		previewImg0.loadGraphic('assets/images/swapcraft/partsoriginals/4forward_0_original.png');
	...
	private function preview1():Void
	{
		...
		previewImg1.loadGraphic('assets/images/swapcraft/partsoriginals/4forward_1_original.png');
	...
	private function preview2():Void
	{
		...
		previewImg2.loadGraphic('assets/images/swapcraft/partsoriginals/4forward_2_original.png');
	...
	private function preview3():Void
	{
		...
		previewImg3.loadGraphic('assets/images/swapcraft/partsoriginals/4forward_3_original.png');
	...
	private function nextState():Void
	{
		...
		FlxG.switchState(new SwapCraftState5());
	}
}